...
goal_aperture = 95  # Setting the initial aperture to 105mm, the maximum, to accommodate the widest part of the bag.
...
additional_closure = 5  # The aperture is reduced by 3mm if slippage is detected, aiming for a tighter grip.
additional_force_increase = 2.0  # If slippage occurs, the force increases by 0.5 Newtons to reinforce the grip without risking damage.
