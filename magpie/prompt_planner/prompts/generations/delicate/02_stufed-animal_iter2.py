...
goal_aperture = 28  # Set the aperture to 25mm as this size is expected to secure the stuffed animal without compressing it too much.
...
G.set_compliance(1, 4, finger='both')  # Setting a slightly higher margin and flexibility for medium compliance handling.

initial_force = 1.5  # Starting with a force of 0.5 Newtons to ensure a secure grip without crushing the object.
...
additional_force_increase = 0.5 # Increase the force by 0.1 Newtons if slippage occurs, for a slightly firmer grip.
