...
goal_aperture = 60.0  # The goal aperture is set to 60 mm to match the size of the paper cup
additional_closure = 2.0  # If the gripper slips, it will close an additional 2 mm
initial_force = 0.8  # The initial force is set to 0.8 Newtons to avoid deforming the paper cup
force_increment = 0.4  # If the gripper slips, the force will increase by 0.4 Newtons
